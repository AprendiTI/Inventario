...
@section('tittle', 'Formulario SemiGuiados')
                    ...
                    <div class="row justify-content-center">
                        ...
                        @foreach ($response as $key => $codes)
                            <div class="col-auto">
                                ...
                                {{-- <button type="button" class="btn btn-secondary" onclick="Mostrar('{{$codes['BarCode']}}')"> <i class="fa fa-eye"></i> </button> --}}
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="contenedor d-none" id="{{$artc['BarCode']}}">
                            <form method="post" action="{{route('conteos.update', $artc['d_id'])}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <h5 class="text-center pb-4 text-danger">Producto N° {{$key+1}}</h5>
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">cogido de barras <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="first-name" required="required" class="form-control " value="{{$artc['BarCode']}}" name="ItemCode" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
