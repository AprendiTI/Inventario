...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <form action="{{route('storenewprod', $id)}}" method="post">
                @csrf
                <div class=" col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                                        ...
                                        <div class="row">
                                            <div class="col-12 py-4 pl-3">
                                                ...
                                                <div class="item form-group" id="name2">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 ">
                                                        <select class="select2 form-control" id="item"  name="descrip" id="user" onchange="producto2()" style="width: 100%;">
...
@section('js')
    ...
    <script>
        ...
        function producto2() {
            let opcion = $("#item option:selected").val();
            $("#ItemCode").val('');
            $("#barcode").val('');
            $("#ItemCode").prop('readonly', false);
            for(let articulo of prods){
